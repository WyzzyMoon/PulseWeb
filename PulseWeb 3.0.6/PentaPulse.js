...
var A1Y = ((((Length) + ((Length) * sin(A1Angle) + (Size / 10)) - Short1Y)) + (RestY - (41/10*(Size/10))));
var A2X = ((((Length) + ((Length) * cos(A2Angle) + (Size / 10)) - Short2X)) + (RestX - (40/10*(Size/10))));
var A2Y = ((((Length) + ((Length) * sin(A2Angle) + (Size / 10)) - Short2Y)) + (RestY - (13/10*(Size/10))));
var A3X = ((((Length) + ((Length) * cos(A3Angle) + (Size / 10)) - Short3X)) + (RestX - (25/10*(Size/10))));
var A3Y = ((((Length) + ((Length) * sin(A3Angle) + (Size / 10)) - Short3Y)) + (RestY + (37/10*(Size/10))));
var A4X = ((((Length) + ((Length) * cos(A4Angle) + (Size / 10)) - Short4X)) + (RestX + (25/10*(Size/10))));
var A4Y = ((((Length) + ((Length) * sin(A4Angle) + (Size / 10)) - Short4Y)) + (RestY + (37/10*(Size/10))));
var A5X = ((((Length) + ((Length) * cos(A5Angle) + (Size / 10)) - Short5X)) + (RestX + (40/10*(Size/10))));
var A5Y = ((((Length) + ((Length) * sin(A5Angle) + (Size / 10)) - Short5Y)) + (RestY - (13/10*(Size/10))));
